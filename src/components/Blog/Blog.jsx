    ...
    <div className="container py-14 ">
        ...
        { blogData.map(data=>{
                ...
                {backgroundColor:"black",
                    ...
                    <div key={data.id} className="flex flex-col items-center justify-center gap-6 p-2 md:p-5 max-w-[300px] mx-auto shadow-lg rounded-md bg-white hover:-translate-y-2 duration-300">
